    ...
    public void init(GameContainer container, StateBasedGame sbg) throws SlickException {
        ...
        try {
            ...
            for (int i = 0; i < 12500; i++) {
                tiledLayer.setTile(rnd.nextInt(128), rnd.nextInt(128), 2);
                tiledLayer.setTile(rnd.nextInt(128), rnd.nextInt(128), 3);
                tiledLayer.setTile(rnd.nextInt(128), rnd.nextInt(128), 6);
            }
